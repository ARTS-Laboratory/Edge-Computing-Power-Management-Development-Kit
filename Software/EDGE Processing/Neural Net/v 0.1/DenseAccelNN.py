...
Dense neural network for raw PATCH PPG heart-rate estimation.

Uses the same training, validation, testing, preprocessing,
and evaluation procedure as the other v0.1 models.
"""
...
def main(train_ids, validation_ids, test_ids):
    ...
    X_validation = torch.tensor(X_validation, dtype=torch.float32).reshape(len(X_validation), -1)
    ...
    output_file = "DenseAccelNN_v0.1_5run_results.csv"
