...
1D CNN for raw PATCH PPG heart-rate estimation.
...
Motion is used only for post-training error analysis.
"""
...
def main(train_ids, validation_ids, test_ids):
    ...
    X_validation = torch.tensor(X_validation[:, :, 0], dtype=torch.float32).unsqueeze(1)
    ...
    output_file = "CNN_5run_results.csv"
